...
document.getElementById("populate_button").onclick = function go(){
  ...
  request.onload = function() {
    if (request.status >= 200 && request.status < 400){
      ...
      console.log(data);
      document.getElementById("giphyme").innerHTML = '<center><img STYLE = "text-align: center; margin: auto; padding: auto;width: auto; height: 328px;
      height: 328px" src = "'+data+'"  title="GIF via Giphy"></center>';
    } else {
